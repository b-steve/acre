...
bearing and distance as extra information, and half normal as detection
function. The coefficients of "alpha", which is used to describe the
randomness of distance, is modeled with additional covariates. The
