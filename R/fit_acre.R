...
#'
#' @examples
fit.acre = function(dat, par_extend_model = NULL, detfn = NULL, sv = NULL, bounds = NULL, fix = NULL, ss.opts = NULL,
                    control.mask = NULL, mask = NULL, control_convert_loc2mask = list(), is_scale = TRUE,
                    par_extend_link = NULL, local = FALSE, tracing = TRUE, gr_skip = FALSE, sv_link = NULL){
