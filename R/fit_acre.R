...
#' @param gr_skip same as the argument with the same name in the function "fit.acre()".
...
#' @param control.mask a list. If it is provided, and the argument "mask" is not provided, it will be used together
...
fit.acre = function(dat, model = NULL, detfn = NULL, sv = NULL, bounds = NULL, fix = NULL, ss.opts = NULL,
                    control.mask = NULL, mask = NULL, convert.loc2mask = list(), is_scale = TRUE,
                    model.link = NULL, local = FALSE, tracing = TRUE, gr_skip = FALSE, sv_link = NULL){
...
#'
#' @param session.cov a data frame. It should contain a column of "session" and any session related covariates as
#'                    extra columns.
...
#' @param dist.cov a list with named elements. Each element is a data frame contains columns "x" and "y", recording
