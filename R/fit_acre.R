...
#' @param control_convert_loc2mask a list. When either the arguments of "mask" or "control.mask" is provided, the mask
...
fit.acre = function(dat, model = NULL, detfn = NULL, sv = NULL, bounds = NULL, fix = NULL, ss.opts = NULL,
                    control.mask = NULL, mask = NULL, control_convert_loc2mask = list(), is_scale = TRUE,
  ...
  if(!is.null(model)){
    ...
    if(mask_override & !is.null(dat$par.extend$data$mask)){
      control_convert_loc2mask$loc.cov = arg.input$loc.cov
...
read.acre = function(captures, traps, mask = NULL,
                    ...
                    control_convert_loc2mask = list(), session.cov = NULL, trap.cov = NULL, dist.cov = NULL,
