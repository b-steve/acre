...
#'              for that function.
#' @param mask a list or a data fload_rame. Generated by the function "create.mask()".
...
fit.acre = function(dat, par_extend_model = NULL, detfn = NULL, sv = NULL, bounds = NULL, fix = NULL, ss.opts = NULL,
                    control_create_mask = NULL, mask = NULL, control_convert_loc2mask = list(), is_scale = TRUE,
...
#' @param control_create_capt a list, contains all other arguments of the function "create.capt()" excluding
