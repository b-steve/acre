...
#'                 ,"ss", "toa".  "animal_ID" could be provided if individuals could be distinguished from their acoustic detection.
#'                 In addition, any individuals from different sessions will be treated as independent ones.
#'                 The default unit for any distance related value should be 'meter', and for time related value should be 'seconds'.. be passed to function "create.capt()", please refer to the description
#'                 for that function. To be passed to function "create.capt()".
