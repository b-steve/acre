...
#' @export
#'
coef.acre_tmb = function(object, types = NULL, pars = NULL, new_covariates = NULL, ...){
...
#' @param new_covariates a data frame, the same as "coef.acre_tmb()".
...
#'
#' @examples
coef.acre_boot = function(object, types = NULL, pars = NULL, new_covariates = NULL, correct_bias = FALSE, ...){
  
  if(!correct_bias){
    output = coef.acre_tmb(object = object, types = types, pars = pars, new_covariates = new_covariates)
    return(output)
  }
...
#' @export
vcov.acre_tmb = function(object, types = NULL, pars = NULL, new_covariates = NULL, show_fixed_par = TRUE, ...){
  ...
  for(type in types){
    if(type == "linked"){
      if(is.null(new_covariates)){
        ...
        #browser()
        output[[type]] = delta_method_acre_tmb(cov_linked, param_values, new_covariates = new_covariates,
...
#'
#' @examples
vcov.acre_boot = function(object, types = NULL, pars = NULL, new_covariates = NULL, from_boot = TRUE, show_fixed_par = TRUE, ...){
  
  if(!from_boot){
    output = vcov.acre_tmb(object = object, types = types, pars = pars, new_covariates = new_covariates, show_fixed_par = show_fixed_par)
    return(output)
  }
...
#' @return a named numeric vector
#' @export
stdEr.acre_tmb = function(object, types = NULL, pars = NULL, new_covariates = NULL, show_fixed_par = TRUE, ...){
  
  output_vcov = vcov.acre_tmb(object = object, types = types, pars = pars, new_covariates = new_covariates,
...
#'
#' @examples
stdEr.acre_boot = function(object, types = NULL, pars = NULL, new_covariates = NULL, from_boot = TRUE, show_fixed_par = TRUE, ...){

  output_vcov = vcov.acre_boot(object = object, types = types, pars = pars, new_covariates = new_covariates,
...
#' @return a matrix
#' @export
confint.acre_tmb = function(object, types = NULL, level = 0.95, pars = NULL, new_covariates = NULL, ...){
...
#' @examples
#' 
confint.acre_boot = function(object, types = NULL, level = 0.95, pars = NULL, new_covariates = NULL,
