...
- Implemented model could fit the data as follows:
  ...
  - acoustic capture history stand along or with the following
  ...
  - extra covariates may affect the animal density or the probability of
    a call to be detected via the capture hisotry information:
...
- options of the the model:
  ...
  - detection function – the model could support detection functions of
    ‘hn’, ‘hhn’, ‘hr’, ‘th’, ‘lth’ and ‘ss’.
  ...
  - specified link function and formula for the relationship between the
    capture history related coefficients and the extra covariates.
...
- plot:
  ...
  - capture history, stand alone or with additional information of
    “animal_ID”, “ss”, “bearing” or “dist”.

  - location related covariates.

  - animal density surface from an output object of a fitted model.
    (through a different function instead of “plot()”)
